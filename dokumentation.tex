...
\fancyhead{}
\fancyfoot{}
\fancyhead[C]{Hochschule für Technik, Wirtschaft und Kultur Leipzig  -- Christian Weckel}
\fancyfoot[C]{Entwicklung einer webfähigen, indexbasierten Suche, am Beispiel von Mitfahrgelegenheiten}
\fancyfoot[R] \thepage
...
14INM}
\title{Masterprojekt\\
Entwicklung einer webfähigen, indexbasierten Suche, am Beispiel von Mitfahrgelegenheiten\\
...
\begin{lstlisting}[caption={Auslesen der Eigenschaften über XPath}, style=JavaStyle, label={xpath}]
...
Das Frontend des Programms ist auch in Java geschrieben. Es handelt sich um eine Java-Webapplikation, welche in einem geeigneten Server, wie Tomcat, ausgeführt werden kann. Der Quelltext des Frontends ist ebenfalls im Github vorzufinden.\footnote{$https://github.com/IVleafclover/RideFinder$}\\
